...
ScrollReveal().reveal(".home__data, .searchParent, .footer__container, .footer__group", {
  origin: "top",
  distance: "60px",
  duration: 2500,
  delay: 400,
...
ScrollReveal().reveal(".logos__img, .program__card, .card, .pricing__card", {
  origin: "top",
  distance: "60px",
  duration: 2500,
  delay: 400,
...
ScrollReveal().reveal(".choose__img, .slider, .calculate__content", {
  origin: "left",
  distance: "60px",
  duration: 2500,
  delay: 400,
